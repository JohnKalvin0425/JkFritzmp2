    ...
    const Navbar = () => {
        ...
        return (
            <div className="Navbar">
                        ...
                        <nav className="md:max-w-[1480px] max-w-[600px] m-auto w-full h-full flex justify-between items-center">
                            ...
                            <div className="hidden md:flex items-center">
                                ...
                                <button className="flex justify-between items-center bg-transparent px-4 gap-2">
                                 ...
                                 <Link  to="#">Log in</Link></button>
                                <button className="px-4 py-3 rounded bg-[#01dada] hover:bg-yellow-300 text-white font-bold">
                ...
                <img className="h-[25px]" src={lock}/>
                Login</button>
             <button className='px-6 py-2 rounded-md bg-[#01dada] text-white font-bold'>Sign Up</button>
                </div>
