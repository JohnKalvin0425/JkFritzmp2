...
<div className="hero min-h-[550px]" style={{backgroundImage: 'url(https://gttp.imgix.net/292344/x/0/)'}}>
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      <h1 className="mt-5 text-5xl font-bold">Hello there</h1>

     < div className="dropdown">
  <label tabIndex={0} className="btn m-1 py-7"><img src={man} className='h-[20px]' alt="Man" />Adult•Children•Room</label>
