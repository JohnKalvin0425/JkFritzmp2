...
import room001 from './hoteimage/room001.webp';
import room002 from './hoteimage/room002.webp';
import room003 from './hoteimage/room003.webp';
import room004 from './hoteimage/room004.webp';
import room005 from './hoteimage/room005.webp';
import room006 from './hoteimage/room006.webp';
import room007 from './hoteimage/room007.jpg';
import room008 from './hoteimage/room008.webp';
...
<div className='bg-gray-100'>
  ...
  <div id="slide1" className="carousel-item relative w-full">
    <img src={room001} className='lg:rounded-l-xl rounded-xl '/>
  ...
  <div id="slide2" className="carousel-item relative w-full">
    <img src={room006} className='lg:rounded-l-xl rounded-xl ' />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  ...
  <div id="slide3" className="carousel-item relative w-full">
    <img src={room008} className='lg:rounded-l-xl rounded-xl '/>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide2" className="btn- btn-circle">❮</a> 
      <a href="#slide4" className="btn- btn-circle">❯</a>
    </div>
  ...
  <div id="slide4" className="carousel-item relative w-full">
    <img src={room09} className='lg:rounded-l-xl rounded-xl ' />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide3" className="btn- btn-circle">❮</a> 
      <a href="#slide1" className="btn- btn-circle">❯</a>
    </div>
              ...
              <div className='md:max-w-[1400px] max-w-[600px] font-semibold  m-auto w-full h-full p-3 rounded-xl mt-12'>
                <h1 className='text-3xl'>Villa, 2 Bedrooms, Garden View</h1>
