...
import room2 from './hoteimage/room1.webp';
import room1 from './hoteimage/room2.webp';
import room3 from './hoteimage/room3.webp';
import room4 from './hoteimage/room4.webp';
import room5 from './hoteimage/room5.webp';
import room6 from './hoteimage/room6.webp';
import room7 from './hoteimage/room7.jpg';
import room8 from './hoteimage/room8.webp';
import room9 from './hoteimage/room9.webp';
import room11 from './hoteimage/room11.jpg';
...
<div className='bg-gray-100'>
  ...
  <div id="slide1" className="carousel-item relative w-full">
    <img src={room1} className='lg:rounded-l-xl rounded-xl '/>
  ...
  <div id="slide2" className="carousel-item relative w-full">
    <img src={room2} className='lg:rounded-l-xl rounded-xl ' />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  ...
  <div id="slide3" className="carousel-item relative w-full">
    <img src={room3} className='lg:rounded-l-xl rounded-xl '/>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide2" className="btn- btn-circle">❮</a> 
      <a href="#slide4" className="btn- btn-circle">❯</a>
    </div>
  ...
  <div id="slide4" className="carousel-item relative w-full">
    <img src={room4} className='lg:rounded-l-xl rounded-xl ' />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide3" className="btn- btn-circle">❮</a> 
      <a href="#slide1" className="btn- btn-circle">❯</a>
    </div>
                ...
                <div className='grid lg:grid-cols-3 lg:ml-0 lg:gap-0 col-span-2 grid-cols-1 gap-5 ml-8'>
                  <div  >
                <img src={room5} className='w-[300px] '/>
                </div>
                <div className='w-[300px] '>
                <img src={room6}/>
                </div>
                <div className='w-[300px] '>
                <img src={room7} className='lg:rounded-tr-xl'/>
                </div>
                <div className='w-[300px]  '>
                <img src={room8} className='h-[225px]' />
                </div>
                <div className='w-[300px] '>
                <img src={room9} />
                </div>
                <div className='w-[300px] '>
                <img src={room11} className='lg:rounded-br-xl'/>
                </div>
