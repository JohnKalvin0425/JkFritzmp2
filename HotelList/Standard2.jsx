...
import room01 from './hoteimage/room01.webp';
import room02 from './hoteimage/room02.webp';
import room03 from './hoteimage/room03.webp';
import room04 from './hoteimage/room04.webp';
import room05 from './hoteimage/room05.webp';
import room6 from './hoteimage/room6.webp';
import room7 from './hoteimage/room7.jpg';
import room8 from './hoteimage/room8.webp';
import room09 from './hoteimage/room09.jpg';
import room011 from './hoteimage/room011.webp';
import square from './hoteimage/square.svg';
import family from './hoteimage/family.svg';
import bed from './hoteimage/bed.svg';
import shower from './hoteimage/shower.svg';
import spoon from './hoteimage/spoon.svg';
import frost from './hoteimage/frost.svg';
import checkroom from './hoteimage/checkroom.svg';
import waves from './hoteimage/waves.svg';
...
<div className='bg-gray-100'>
  ...
  <div id="slide1" className="carousel-item relative w-full">
    <img src={room01} className='lg:rounded-l-xl rounded-xl '/>
  ...
  <div id="slide2" className="carousel-item relative w-full">
    <img src={room6} className='lg:rounded-l-xl rounded-xl ' />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
  ...
  <div id="slide3" className="carousel-item relative w-full">
    <img src={room7} className='lg:rounded-l-xl rounded-xl '/>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide2" className="btn- btn-circle">❮</a> 
      <a href="#slide4" className="btn- btn-circle">❯</a>
    </div>
  ...
  <div id="slide4" className="carousel-item relative w-full">
    <img src={room8} className='lg:rounded-l-xl rounded-xl ' />
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide3" className="btn- btn-circle">❮</a> 
      <a href="#slide1" className="btn- btn-circle">❯</a>
    </div>
                ...
                <div className='grid lg:grid-cols-3 lg:ml-0 lg:gap-0 col-span-2 grid-cols-1 gap-5 ml-8'>
                  <div  >
                <img src={room02} className='w-[300px] '/>
                </div>
                <div className='w-[300px] '>
                <img src={room03}/>
                </div>
                <div className='w-[300px] '>
                <img src={room04} className='lg:rounded-tr-xl'/>
                </div>
                <div className='w-[300px]  '>
                <img src={room05} className='h-[225px]' />
                </div>
                <div >
                <img src={room09} className='w-[300px]  h-[225px]' />
                </div>
                <div className='w-[300px] '>
                <img src={room011} className='lg:rounded-br-xl'/>
                </div>
    ...
    <div className=' mb-10 mt-12'>
      ...
      <div className='col-span-2'>
        <div className='border p-3 rounded-xl'>
          ...
          <div className='flex'>
            <img src={checkroom} className='w-[20px] h-[20px]' />
          ...
          <div className='flex justify-end'>
            <button className='bg-yellow-300 p-4 rounded-xl font-semibold'>BOOK NOW</button>
          </div>
        </div>
      </div>
      </div>
